				...
				<div class="row">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-filter"></i>Cadastro de usuários - <?php echo $itens->num_rows(); ?> registro(s)
							</div>
							<div class="actions">
								<div class="btn-group">
							...
							<table class="table table-hover datatable" id="sample_3">
								...
								<tr align="center">
										...
										<td><a class="btn btn-success btn-xs"
											href="<?php echo base_url('comercial/prospecto/editar') . "/" . $item -> Id; ?>"><i
												class="fa fa-edit"></i> Editar</a><a
											class="btn btn-primary btn-xs"
											href="<?php echo base_url('comercial/prospecto/registrar') . "/" . $item -> Id; ?>"><i
												class="fa fa-edit"></i> Registrar</a><a
											class="btn btn-danger btn-xs"
											href="<?php echo base_url('comercial/prospecto/remover') . "/" . $item -> Id; ?>"><i
												class="fa fa-trash-o fa-lg"></i> Remover</a></td>
									</tr>
								<?php } ?>
							</tbody>
							</table>
