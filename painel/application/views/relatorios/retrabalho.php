			...
			<div class="page-content">
				...
				<div class="row">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bar-chart"></i>Gráfico retrabalho
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse" data-original-title=""
									title=""> </a> <a href="" class="fullscreen"
						...
						<div class="portlet-body">
							<?php $meses =  $retrabalhos->num_rows(); $meses_total =  $retrabalhos->num_rows();?>
							<?php
								...
								// Pegas os valores de mes e total do retrabalho
								for ($i=0; $i < $meses; $i++) {
									$row = $retrabalhos->row($i);
