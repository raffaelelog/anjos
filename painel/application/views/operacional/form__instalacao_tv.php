                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group equipamentos">
                                            ...
                                            <select name="cod_produtoitem[]" class="form-control cod_produtoitem" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hora_entrada" class="form-control hora" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Hora Saída</label>
                                            <input type="text" name="hora_saida" class="form-control hora" required>
                                        </div>
