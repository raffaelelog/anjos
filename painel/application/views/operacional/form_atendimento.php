                    ...
                    <div class="row">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-wrench"></i>Fechar Atendimento </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Hora Entrada Ex.: 08:00</label>
                                            <input type="text" name="hora_entrada" class="form-control hora" onkeyup="maskIt(this,event,'##:##')" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Hora Saída Ex.: 09:05</label>
                                            <input type="text" name="hora_saida" class="form-control hora" onkeyup="maskIt(this,event,'##:##')" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" class="btn btn-primary btn-block" name="fechar" value="Fechar Atendimento">
                                        </div>
