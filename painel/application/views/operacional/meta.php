			...
			<div class="page-content">
				...
				<h1 class="page-title">
					...
					<div class="btn-group pull-right" role="group">
						<a class="btn btn-default btn-sm btn btn-secondary"
							href="<?php echo base_url('operacional/servicos/metas'); ?>"> <i
							class="fa fa-users"></i> Metas-Usuarios
						</a>
						<a class="btn btn-default btn-sm btn btn-secondary"
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">
									Editar Meta do Técnico <?php echo $dados->row(0)->nome;?> <br><?php echo $dados->row(0)->descri_setor." (".$dados->row(0)->descri_unidade.")";?> 
								</h4>
							</div>
							<form class="form-group" name="formulario" action="" method="post">
								<div class="modal-body">
									<div class="form-group col-md-12">
										...
										<input type="number" class="form-control valor_editado" value="#" max="99" min="1" step="1" class="form-control" name="valor_editado" id="valor_editado" autocomplete="off"> 
				...
				<div class="row">
						...
						<div class="portlet-body">
							<form action="" method="post">
								<div class="form-group col-md-3">
									<label>Meta</label> 
									<input type="number" required="required" name="valor_meta" class="form-control" max="99" min="1" step="1"">
								</div>
								<div class="form-group col-md-3">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-wrench"></i>Metas do Técnico - <?php echo $dados->row(0)->nome; ?>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse" data-original-title=""
									title=""> </a> <a href="" class="fullscreen"
								...
								<tbody>
                                    <?php foreach ($meta->result() as $item) { ?>
                                    	<tr>
											...
											<td><?php if($valor!=null){ echo '<a class="editar btn btn-success btn-sm btn-block" data-valor="'.$valor.'" data-id="'.$item->cod_meta.'"><i class="fa fa-edit"></i>Editar</a>';} ?></td>
										</tr>  
                                    <?php } ?>
                               	</tbody>
							</table>
