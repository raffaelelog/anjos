                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="radio_ap" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label>Ruído</label>
                                            <input type="text" name="r_ruido" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label>Antena</label>
                                            <select name="radio_antena" class="form-control cod_produtoitem" required>
                                                <option value="">Selecione...</option>
                                                <?php foreach ($redes_tipo_antena->result() as $antena): ?>
                                                 <option value="<?php echo $antena->descricao; ?>">
                                                    <?php echo $antena->descricao; ?>
                                                 </option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Sinal</label>
                                            <input type="text" name="fr_budget" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" class="btn btn-primary btn-block" name="fechar" value="Fechar Serviço Rádio">
                                        </div>
