					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<form class="form-group"
								action="<?php echo base_url('usuarios/novo_usuario'); ?>"
								method="post">
								<div class="modal-body">
									<div class="form-group col-md-6">
										<label for="nome">Nome</label> <input type="text"
											class="form-control" name="nome" id="nome"
											required="required" value="<?php echo set_value('nome'); ?>">
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										...
										<select name="cod_setor" class="form-control" required="required">
											<option value="">Selecione...</option>
                          					<?php foreach ( $setores->result () as $setor ) { echo '<option value="' . $setor->cod_setor . '">' . $setor->descri_setor . '</option>'; } ?>
                          				</select>
									</div>
									<!-- RECEBE UNIDADES -->
									<div class="form-group col-md-12">
										<label for="email">Unidade</label> 
										<select name="cod_unidade"
											class="form-control" required="required">
											<option value="">Selecione...</option>
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" name="telefone_1" id="telefone_1" maxlength="14" minlength="0" required="required" value="<?php echo set_value('telefone_1'); ?>" onkeyup="maskIt(this,event,'(##)#####-####')" onBlur="maskIt(this,event,'(##)#####-#####')">
									</div>
									<div class="form-group col-md-6">
										<label for="telefone_2">telefone 2</label> 
										<input type="text" class="form-control" name="telefone_2" id="telefone_2" maxlength="14" value="<?php echo set_value('telefone_2'); ?>"  onkeyup="maskIt(this,event,'(##)#####-####')" onBlur="maskIt(this,event,'(##)#####-#####')">
									</div>
									<!-- USUÁRIO ATIVO/INATIVO -->
									<div class="form-group col-md-6">
										<label for="ativo">Usuário Ativo: </label> <label><input
											type="radio" name="ativo" value="1" checked="checked">Sim</label>
										<label><input type="radio" name="ativo" value="0">Não</label>
									</div>
									<!-- USUÁRIO TECNICO -->
									<div class="form-group col-md-6">
										<label for="tecnico">Técnico Externo: </label><label><input
											type="radio" name="tecnico" value="1">Sim</label>
										<label><input type="radio" name="tecnico" value="0" checked="checked">Não</label>
									</div>
									<div class="clearfix"></div>
									<hr>
									<div class="form-group col-md-6">
					            ...
					            <table class="table table-striped table-bordered datatable" id="sample_3">
									...
									<tbody>
					              	<?php if ($usuarios) { foreach ( $usuarios->result () as $usuario ) { ?> 
					                    ...
					                    <a href="<?php echo base_url('usuarios/excluir_usuario')."/".$cod_usuario ?>"><i class="fa fa-close"></i></a> 
					                    <a href="<?php echo base_url('usuarios/editar_usuario')."/".$cod_usuario ?>"><i class="fa fa-edit"> </i></a> 
					                    <a href="<?php echo base_url('usuarios/permissoes')."/".$cod_usuario ?>"><i class="fa fa-lock"> </i></a>
											</td>
										</tr>
					                <?php } } ?>
					              </tbody>
