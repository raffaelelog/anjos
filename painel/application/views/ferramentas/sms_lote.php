				...
				<div class="row">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-wrench"></i>Formulário de envio em Lote
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
                                ...
                                <?php } ?>                               
                                <div class="col-md-6">
								<h3>Leia antes de usar o envio em Lote</h3>
								<ul class="list-group">
									<li class="list-group-item"><i class="fa fa-arrow-right"></i> O
										número deve ser inserido no formato DDD+Número e sem espaços,
										exemplo: 32984111234</li>
									<li class="list-group-item"><i class="fa fa-arrow-right"></i>
										Separe cada numero com virgula e sem espaco. Ex.:
										(32988221234,32984005432)</li>
									<li class="list-group-item text-danger">Os números enviados com
										erro também são cobrados pela operadora.</li>
									<li class="list-group-item"><i class="fa fa-arrow-right"></i>
								...
								<form action="" method="post">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="in_to"
											placeholder="Exemplo: 32991231234,32984221234" name="toInput">
									</div>
									...
									<div class="form-group">
										<input type="submit" class="btn btn-primary btn-block"
											name="enviar" value="Enviar Mensagem">
									</div>
								</form>
							</div>
